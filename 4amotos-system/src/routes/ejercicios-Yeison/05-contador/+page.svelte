...
<script lang="ts">
    ...
    function valorAbsoluto() {
        const resultado = Math.abs(Number(contador));
    ...
    <section class="area-trabajo">
        ...
        <div class="tarea">
            ...
            <div class="area-experimental">
                ...
                <button onclick={valorAbsoluto} class="btn btn-custom">
                    |x| Valor Absoluto
                </button>

                <button onclick={cambiarSigno} class="btn btn-custom">
                    ± Cambiar Signo
                </button>

                <button onclick={sumarCien} class="btn btn-custom">
                    +100 Sumar 100
                </button>

                <button onclick={irAlLimite} class="btn btn-custom">
                    ↗️ Ir al Límite
                </button>
