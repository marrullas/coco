...
<script lang="ts">
    ...
    import {
        detectarRutaBase,
        generarRutasEjercicios,
    } from "$lib/utils/navigation";
    import { ejerciciosData } from "$lib/data/ejercicios";
    ...
    const ejercicios = $derived(
        generarRutasEjercicios(ejerciciosData, rutaBase),
    );

    let totalEjercicios = $derived(
        ejercicios.reduce((total, nivel) => total + nivel.ejercicios.length, 0),
    );
</script>
...
<svelte:head>
    ...
    <meta
        name="description"
        content="Ejercicios progresivos de Svelte 5 para aprender programación desde cero"
    />
</svelte:head>
...
<main class="contenedor">
    ...
    <header class="encabezado">
        ...
        <p class="subtitulo">
            Aprende programación desde cero con {totalEjercicios} ejercicios progresivos
        </p>
        <div class="stats">
    ...
    <section class="instrucciones">
        ...
        <div class="tarjeta">
            <ul>
                <li>
                    <strong>🎯 Sigue el orden:</strong> Cada ejercicio construye
                    sobre el anterior
                </li>
                <li>
                    <strong>💻 Práctica:</strong> Escribe el código tú mismo, no
                    copies y pegues
                </li>
                <li>
                    <strong>🤔 Experimenta:</strong> Cambia valores y observa qué
                    pasa
                </li>
                <li>
                    <strong>❓ Pregunta:</strong> Si te atascas, revisa el ejercicio
                    anterior o pide ayuda
                </li>
                <li>
                    <strong>🎉 Celebra:</strong> ¡Cada ejercicio completado es un
                    logro!
                </li>
            </ul>
        </div>
    ...
    <footer class="footer">
        <p>
            🚀 Desarrollado para el programa ADSO - Aprendiendo Svelte 5 paso a
            paso
        </p>
    </footer>
</main>
...
<style>
    ...
    /* Colores por nivel */
    .ejercicios-grid:nth-of-type(1) .ejercicio-numero {
        background: var(--color-verde);
    }
    .ejercicios-grid:nth-of-type(2) .ejercicio-numero {
        background: var(--color-amarillo);
    }
    .ejercicios-grid:nth-of-type(3) .ejercicio-numero {
        background: var(--color-naranja);
    }
    .ejercicios-grid:nth-of-type(4) .ejercicio-numero {
