...
<script lang="ts">
    ...
    let promedio = $state<number>(2.5);

    // ✏️ ESCRIBE AQUÍ MÁS VARIABLES PARA EXPERIMENTAR:
    let ciudad = $state<string>("Santa Marta");
    let telefono = $state<string>("+5732341324");
        ...
        <div class="tarea">
            ...
            <div class="resultado">
                ...
                <div class="info-card">
                    ...
                    <p>
                        <strong>Edad el próximo año:</strong>
                        {edad + 10} años
                    </p>
                    <p>
        ...
        <div class="tarea">
            ...
            <div class="resultado">
                ...
                <div class="info-card">
                    ...
                    <p><strong>Institución:</strong> {universidad}</p>
        ...
        <div class="tarea">
            ...
            <div class="resultado">
                ...
                <div class="info-card experimental">
                    ...
                    <p>
                        <strong>Primer letra del nombre y del Apellido</strong>
                        {nombre[0]}
                        {apellido[1]}
                    </p>
