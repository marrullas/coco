...
<script lang="ts">
    ...
    function cambiarColor() {
        const colores = ["#5A5AE0", "#add8e6", "#90ee90", "#fffacd", "#ffc0cb"];
...
<main class="contenedor" style="background-color: {colorFondo}">
    ...
    <header class="instrucciones">
        ...
        <div class="objetivos">
            ...
            <ul>
                <li>
                    Conectar botones con funciones usando <code>onclick</code>
                </li>
    ...
    <section class="area-trabajo">
        ...
        <div class="tarea">
            ...
            <p>
                <strong>Instrucción:</strong> Observa cómo funcionan estos botones
                básicos
            </p>
            ...
            <div class="pista">
                💡 <strong>Pista:</strong> Cada botón llama a una función diferente.
                ¡Observa cómo cambia la pantalla!
            </div>
        </div>
        ...
        <div class="tarea">
            ...
            <p>
                <strong>Instrucción:</strong> Este botón usa matemáticas (random)
            ...
            <div class="pista">
                💡 <strong>Observa:</strong> Esta función usa
                <code>Math.random()</code> para elegir colores aleatorios
            </div>
        </div>
        ...
        <div class="tarea">
            ...
            <p>
                <strong>Instrucción:</strong> Agrega tu propia función y botón
            </p>
            ...
            <div class="area-experimental">
                ...
                -->
                <button onclick={miFraseFavorita} class="btn btn-custom">
                    🚀 Mi Botón Especial
                </button>
    ...
    <section class="teoria">
        ...
        <div class="concepto-teoria">
            ...
            <p>
                Un evento es algo que pasa en la aplicación (como hacer click).
                En Svelte 5, conectamos eventos con funciones usando <code
                    >onclick</code
                >.
            </p>
        ...
        <div class="concepto-teoria">
            ...
            <p>
                Cuando una función cambia una variable de estado, Svelte
                actualiza automáticamente todo lo que usa esa variable en la
                pantalla. ¡Es magia! ✨
            </p>
            ...
            <div class="codigo-ejemplo">
                ...
                <pre><code>
                    function contarClick() {"vecesClickeado = vecesClickeado + 1;"}
</code></pre>
            </div>
        </div>
