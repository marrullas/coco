...
import { n as noop, b as deferred } from "../../chunks/utils2.js";
...
function Counter($$payload, $$props) {
  ...
  $$payload.out.push(`<div class="counter svelte-1czwagy"><button aria-label="Decrease the counter by one" class="svelte-1czwagy"><svg aria-hidden="true" viewBox="0 0 1 1" class="svelte-1czwagy"><path d="M0,0.5 L1,0.5" class="svelte-1czwagy"></path></svg></button> <div class="counter-viewport svelte-1czwagy"><div class="counter-digits svelte-1czwagy"${attr_style(`transform: translate(0, ${stringify(100 * offset)}%)`)}><strong class="hidden svelte-1czwagy" aria-hidden="true">${escape_html(Math.floor(count.current + 1))}</strong> <strong class="svelte-1czwagy">${escape_html(Math.floor(count.current))}</strong></div></div> <button aria-label="Increase the counter by one" class="svelte-1czwagy"><svg aria-hidden="true" viewBox="0 0 1 1" class="svelte-1czwagy"><path d="M0,0.5 L1,0.5 M0.5,0 L0.5,1" class="svelte-1czwagy"></path></svg></button></div>`);
  pop();
}
...
function _page($$payload) {
  head($$payload, ($$payload2) => {
    ...
    $$payload2.out.push(`<meta name="description" content="Svelte demo app"/>`);
  });
  $$payload.out.push(`<section class="svelte-1uha8ag"><h1 class="svelte-1uha8ag"><span class="welcome svelte-1uha8ag"><picture><source${attr("srcset", welcome)} type="image/webp"/> <img${attr("src", welcomeFallback)} alt="Welcome" class="svelte-1uha8ag"/></picture></span> to your new<br/>SvelteKit app</h1> <h2>try editing <strong>src/routes/+page.svelte</strong></h2> `);
  Counter($$payload);
